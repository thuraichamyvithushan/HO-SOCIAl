...
const Sidebar = ({ isOpen, toggleSidebar }) => {
    ...
    const navItems = isAdmin ? [
        ...
        { name: 'New Assignment', path: '/admin/create-post', icon: PlusSquare },
        { name: 'Content Archive', path: '/admin-dashboard?tab=archive', icon: FileText },
    ] : [
        { name: 'My Assignments', path: '/dashboard', icon: LayoutDashboard },
    ];
