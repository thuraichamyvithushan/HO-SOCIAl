...
const AdminDashboard = () => {
    ...
    const statCards = [
        ...
        { title: 'Total Assignments', value: stats.totalPosts, icon: FileText, color: 'text-black' },
        { title: 'Active Briefings', value: stats.activeAssignments, icon: CheckCircle, color: 'text-black' },
    ];
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b-4 border-black pb-8">
                <div>
                    <h1 className="text-2xl md:text-6xl font-black text-black tracking-tighter uppercase italic">
                        Administrative <span className="text-primary-600">Portal.</span>
                    </h1>
                    <p className="text-gray-400 font-bold uppercase tracking-[0.2em] md:tracking-[0.3em] text-[10px] md:text-xs mt-2">
                        Overseeing user access and content distribution
                    </p>
                </div>
                                ...
                                <Link to={`/post/${post._id}`} key={post._id} className="group flex items-center gap-4 md:gap-6 p-4 md:p-6 border-2 border-transparent hover:border-black transition-all bg-white">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <p className="text-[8px] md:text-[10px] font-bold text-gray-400 uppercase tracking-widest truncate">
                                            Replied by {post.lastRepliedBy} • {new Date(post.lastActivity).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })} • {post.totalReplies} Replies
                                        </p>
                                    </div>
                    ...
                    <div className="space-y-4">
                        <Link to="/admin/create-post" className="group flex items-center justify-between p-4 md:p-6 border-2 border-black bg-white hover:bg-black transition-all">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <p className="text-xs md:text-sm font-black uppercase tracking-tight group-hover:text-white transition-colors">Create Content</p>
                                    <p className="text-[8px] md:text-[10px] font-bold text-gray-400 uppercase tracking-widest mt-1">Assign new materials</p>
                                </div>
                            </div>
                        ...
                        <Link to="/admin/users" className="group flex items-center justify-between p-4 md:p-6 border-2 border-black bg-white hover:bg-black transition-all">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <p className="text-xs md:text-sm font-black uppercase tracking-tight group-hover:text-white transition-colors">User Audit</p>
                                    <p className="text-[8px] md:text-[10px] font-bold text-gray-400 uppercase tracking-widest mt-1">Review permissions</p>
                                </div>
                            </div>
                            <ArrowRight size={18} className="text-primary-600 opacity-0 group-hover:opacity-100 transition-all" />
                        </Link>
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 border-b-4 border-black pb-8 mb-0">
                    <div>
                        <h1 className="text-2xl md:text-4xl font-black text-black tracking-tighter uppercase italic">
                            Manage <span className="text-primary-600">Assignments.</span>
                        </h1>
                        <p className="text-gray-400 font-bold uppercase tracking-[0.2em] text-[10px] md:text-xs mt-2">
                            Controlling social production and team workflow
                        </p>
                    </div>
                    <div className="hidden md:block text-right">
                        <p className="text-[10px] font-black uppercase text-gray-400 tracking-widest">Total Assignments</p>
                        <p className="text-sm font-black text-primary-600 uppercase tracking-tighter">{totalItems} Assignments</p>
                    </div>
                </div>
